import sys
# 在导入deepdoc.parser之前添加修复
sys.modules['exceptions'] = sys.modules['builtins']
...
from rag.nlp import tokenize, tokenize_table, add_positions, bullets_category, title_frequency, tokenize_chunks, docx_question_level
# Import rag_tokenizer as a module, not from rag.nlp
